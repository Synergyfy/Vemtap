...
import { Business, BusinessType } from '../../src/modules/businesses/entities/business.entity';
...
import { TriggerType, ActionType } from '../../src/modules/messaging/enums/automation.enum';
    ...
    describe('Business Dashboard E2E', () => {
        ...
        it('PATCH /automations/:id/configure - should save valid configurations', async () => {
            const res = await request(app.getHttpServer())
                ...
                .set('Authorization', `Bearer ${ownerToken}`)
                .send({
                    content: 'Hello {{visitor_name}}, thanks for visiting {{business_name}}!',
                    loyaltyPoints: 50,
                })
                .expect(200);
