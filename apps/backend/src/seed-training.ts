...
async function bootstrap() {
  ...
  const orientationCourse = await trainingService.createCourse({
    ...
    description: 'Master the art of offline-to-online conversion and start earning commissions.',
    level: 'Beginner',
    duration: '45 mins',
    order: 1,
    scenarios: [
      {
        scenario: "You walk into a busy restaurant. The manager is occupied. What's your first move?",
        options: [
          { text: "Interrupt and show your NFC tag immediately.", correct: false, feedback: "Too aggressive. Wait for a natural opening." },
          { text: "Observe their current 'menu' situation and wait for a calm moment.", correct: true, feedback: "Perfect. Observation helps you tailor your pitch." },
          { text: "Leave a flyer on the counter and walk out.", correct: false, feedback: "Low conversion. Personal connection is key." }
        ]
      },
      {
        scenario: "The client asks: 'Why is this better than a simple QR code?'",
        options: [
          { text: "It's not, it's just fancier.", correct: false, feedback: "Incorrect. NFC offers higher engagement and data capture." },
          { text: "NFC is faster, more secure, and works even without scanning an app.", correct: true, feedback: "Exactly. The friction-less 'Tap' experience is the win." }
        ]
      }
    ],
    quiz: [
      {
        question: "What is the standard direct commission for a Vemtap referral?",
        options: ["10%", "15%", "20%", "25%"],
        correct: 2
      },
      {
...
As an affiliate, you are not just selling a tool; you are selling **growth**.
    ...
    duration: '5 mins',
    order: 1,
    summary: ['Understand data capture value', 'Focus on merchant growth', 'Setup your NFC demo tag']
  });
...
Always lead with a 'Free Trial' offer. Most merchants can't say no to a 7-day test run.
    ...
    duration: '10 mins',
    order: 2,
    summary: ['Get your demo kit', 'Start with friends/family businesses', 'Use the 7-day trial hook']
  });
