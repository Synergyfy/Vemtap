...
export class MarketingTemplate extends AbstractBaseEntity {
  ...
  @ApiProperty({
    example: 'Restaurant',
    description: 'Business category the template is suited for',
  })
  @Column()
  category: string;
  ...
  @ApiProperty({
    example: 'table_tent',
    description:
      'Type of the template (table_tent, poster, flyer, business_card)',
  })
  @Column()
  type: string;
  ...
  @ApiProperty({
    description:
      'Full HTML/CSS canvas layout structure and design system configurations',
  })
  @Column({ type: 'jsonb' })
  layoutConfig: any;
  ...
  @ApiProperty({
    example: 'https://cdn.vemtap.com/templates/table-tent-sleek.png',
    nullable: true,
  })
  @Column({ nullable: true })
  thumbnailUrl: string;
  ...
  @ApiProperty({
    description: 'QR Code styling defaults (colors, margin, dots, corners)',
  })
