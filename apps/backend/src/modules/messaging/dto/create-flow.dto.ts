...
export class CreateFlowDto {
    ...
    @ApiProperty({
        ...
        description: 'The branch ID. Optional for all roles. For non-admins, defaults to use the branch of the current user if they are tied to one.',
        required: false,
    })
    @IsUUID()
    @IsOptional()
    ...
    @ApiProperty({
        ...
        description: 'The business ID. Required for Admin but automatically determined from token for Owner, Manager, and Staff.',
        required: false,
    })
    @IsUUID()
    @IsOptional()
