...
describe('CreditPlanService', () => {
    ...
    beforeEach(async () => {
        ...
        creditPlanRepo = module.get<Repository<CreditPlan>>(getRepositoryToken(CreditPlan));
        businessCreditRepo = module.get<Repository<BusinessCredit>>(getRepositoryToken(BusinessCredit));
    ...
    describe('purchase', () => {
        ...
        it('should throw BadRequestException if payment verification fails', async () => {
            ...
            await expect(service.purchase('bus-123', 'plan-123', 'ref-fail'))
        ...
        it('should throw BadRequestException if paid amount is insufficient', async () => {
            ...
            await expect(service.purchase('bus-123', 'plan-123', 'ref-low'))
                .rejects.toThrow(BadRequestException);
        });
        ...
        it('should throw NotFoundException if plan does not exist', async () => {
            ...
            await expect(service.purchase('bus-123', 'invalid-plan', 'ref'))
