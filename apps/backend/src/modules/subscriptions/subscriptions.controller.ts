...
export class SubscriptionsController {
    ...
    @ApiResponse({ status: 200, description: 'Return current active plan details' })
    ...
    @ApiOperation({ summary: 'View capability details and limits used for the current subscription' })
    @ApiResponse({ status: 200, description: 'Return capability limits and used counts' })
    ...
    @ApiOperation({ summary: 'Admin: Get all subscriptions with business and plan details' })
    async findAllAdmin() {
