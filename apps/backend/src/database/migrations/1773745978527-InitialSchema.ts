...
export class InitialSchema1773745978527 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE INDEX "IDX_1616d2a7df0c5b8c953d0b90fd" ON "redemptions" ("businessId") `);
        ...
        await queryRunner.query(`ALTER TABLE "message_templates" ADD CONSTRAINT "FK_aa55f75ea880e40fc080c41c5e7" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "devices" ADD CONSTRAINT "FK_0b06457274d1f798765e0f54894" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "contacts" ADD CONSTRAINT "FK_027fc6266b4872da233f67f6114" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "flow_logs" ADD CONSTRAINT "FK_d8230e9d51ba057b6a20e2f32f6" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" ADD CONSTRAINT "FK_842fa5e8d55b91087f019f2a729" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "business_credits" ADD CONSTRAINT "FK_c1570b5f605d1ccf2ce2c86ad27" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "business_credit_wallets" ADD CONSTRAINT "FK_40521a797b5ab05352aeda36e12" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "business_credit_wallets" DROP CONSTRAINT "FK_40521a797b5ab05352aeda36e12"`);
        await queryRunner.query(`ALTER TABLE "business_credits" DROP CONSTRAINT "FK_c1570b5f605d1ccf2ce2c86ad27"`);
        await queryRunner.query(`ALTER TABLE "chat_categories" DROP CONSTRAINT "FK_741b6bbe203f5dad5664d1a9f72"`);
        await queryRunner.query(`ALTER TABLE "credit_transactions" DROP CONSTRAINT "FK_842fa5e8d55b91087f019f2a729"`);
        await queryRunner.query(`ALTER TABLE "flow_logs" DROP CONSTRAINT "FK_d8230e9d51ba057b6a20e2f32f6"`);
        ...
        await queryRunner.query(`ALTER TABLE "contacts" DROP CONSTRAINT "FK_027fc6266b4872da233f67f6114"`);
        ...
        await queryRunner.query(`ALTER TABLE "message_templates" DROP CONSTRAINT "FK_aa55f75ea880e40fc080c41c5e7"`);
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_1616d2a7df0c5b8c953d0b90fd"`);
