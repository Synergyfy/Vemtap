...
export class AddFosModuleTables1780508656001 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."fos_financial_targets_periodtype_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."fos_transactions_platform_enum"`);
