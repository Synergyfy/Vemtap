...
export class SubscriptionTrialsAndCredits1771938140503 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" DROP CONSTRAINT IF EXISTS "FK_e511eec2dd0a93192bdfdcd4de2"`,
    );
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" DROP CONSTRAINT IF EXISTS "FK_80d0596c9acaf40cf1ba7175aed"`,
    );
    await queryRunner.query(
      `ALTER TABLE "redemptions" DROP CONSTRAINT IF EXISTS "FK_ffd3fb3e7583a259ce2beecd15a"`,
    );
    await queryRunner.query(
      `ALTER TABLE "redemptions" DROP CONSTRAINT IF EXISTS "FK_ddb9c853d8602bea573b46334b1"`,
    );
    await queryRunner.query(
      `ALTER TABLE "rewards" DROP CONSTRAINT IF EXISTS "FK_fef5462e98502631a6af0289495"`,
    );
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" DROP CONSTRAINT IF EXISTS "FK_73106f06fac64eaded06516a3a4"`,
    );

    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_e511eec2dd0a93192bdfdcd4de"`,
    );
    await queryRunner.query(
      `DROP INDEX IF EXISTS "public"."IDX_80d0596c9acaf40cf1ba7175ae"`,
    );

    // PLANS: Rename and update instead of Drop/Add
    await queryRunner.query(
      `ALTER TABLE "plans" RENAME COLUMN "freeDurationDays" TO "trialDurationDays"`,
    );
    await queryRunner.query(
      `UPDATE "plans" SET "trialDurationDays" = 30 WHERE "trialDurationDays" IS NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "trialDurationDays" SET DEFAULT 30`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "trialDurationDays" SET NOT NULL`,
    );
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE "rewards" ALTER COLUMN "businessId" TYPE uuid USING "businessId"::uuid`,
      );
      await queryRunner.query(
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE "loyalty_profiles" ALTER COLUMN "businessId" TYPE uuid USING "businessId"::uuid`,
      );
      await queryRunner.query(
    ...
    try {
      await queryRunner.query(
        `ALTER TABLE "redemptions" ALTER COLUMN "branchId" TYPE varchar USING "branchId"::varchar`,
      );
    } catch (e) {
      await queryRunner.query(
    ...
    // New Plan Columns
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "features" text array NOT NULL DEFAULT '{}'`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "smsCredits" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "emailCredits" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ADD "whatsappCredits" integer NOT NULL DEFAULT '0'`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" ADD "paystackAuthorizationCode" text`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE IF EXISTS "public"."loyalty_profiles_tierlevel_enum"`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    // Basic revert logic
    await queryRunner.query(
      `ALTER TABLE "plans" DROP COLUMN "whatsappCredits"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "plans" RENAME COLUMN "trialDurationDays" TO "freeDurationDays"`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "freeDurationDays" DROP NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "plans" ALTER COLUMN "freeDurationDays" DROP DEFAULT`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "subscriptions" DROP COLUMN "trialEndDate"`,
    );
  }
}
