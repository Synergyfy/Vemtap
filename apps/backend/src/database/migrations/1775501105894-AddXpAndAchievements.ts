...
export class AddXpAndAchievements1775501105894 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "business_profiles" ADD "xpEarned" integer NOT NULL DEFAULT '0'`,
    );
    await queryRunner.query(
      `ALTER TABLE "business_profiles" ADD "achievements" jsonb NOT NULL DEFAULT '[]'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "business_profiles" DROP COLUMN "achievements"`,
    );
    await queryRunner.query(
      `ALTER TABLE "business_profiles" DROP COLUMN "xpEarned"`,
    );
  }
}
