...
export class UpdateUserEntity1772012215896 implements MigrationInterface {
    name = 'UpdateUserEntity1772012215896'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "loyalty_profiles" ALTER COLUMN "businessId" DROP NOT NULL`);
