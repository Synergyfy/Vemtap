...
export class UpdateMessageCampaignNullableBranch1772638310069 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "message_campaigns" ADD "businessId" uuid`,
    );
    await queryRunner.query(
      `UPDATE "message_campaigns" mc SET "businessId" = b."businessId" FROM "branches" b WHERE mc."branchId" = b."id"`,
    );
    ...
    await queryRunner.query(
      `ALTER TABLE "message_campaigns" ALTER COLUMN "branchId" DROP NOT NULL`,
    );
    await queryRunner.query(
