...
export class AddAgentDashboardSupport1772794070138 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "support_tickets" ADD "priority" "public"."support_tickets_priority_enum" NOT NULL DEFAULT 'Normal'`);
        await queryRunner.query(`CREATE TYPE "public"."support_tickets_type_enum" AS ENUM('Chat', 'Ticket')`);
        await queryRunner.query(`ALTER TABLE "support_tickets" ADD "type" "public"."support_tickets_type_enum" NOT NULL DEFAULT 'Ticket'`);
        await queryRunner.query(`ALTER TABLE "support_tickets" ADD "channel" character varying`);
        await queryRunner.query(`ALTER TABLE "support_tickets" ADD "assignedToId" uuid`);
        await queryRunner.query(`ALTER TYPE "public"."users_role_enum" RENAME TO "users_role_enum_old"`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('Owner', 'Manager', 'Staff', 'Admin', 'Customer', 'Agent')`);
        ...
        await queryRunner.query(`ALTER TABLE "support_tickets" ALTER COLUMN "category" DROP NOT NULL`);
        ...
        await queryRunner.query(`ALTER TABLE "support_tickets" ALTER COLUMN "status" SET DEFAULT 'Pending'`);
        ...
        await queryRunner.query(`CREATE INDEX "IDX_0bec69b640265cb806d96eb4c4" ON "support_tickets" ("type") `);
        await queryRunner.query(`CREATE INDEX "IDX_947e77544ab7d5fd9521c44e06" ON "support_tickets" ("assignedToId") `);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_947e77544ab7d5fd9521c44e06"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_0bec69b640265cb806d96eb4c4"`);
        ...
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostWhatsapp" SET DEFAULT 0.08`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostSms" SET DEFAULT 0.05`);
        await queryRunner.query(`CREATE TYPE "public"."support_tickets_status_enum_old" AS ENUM('Closed', 'In Progress', 'Open')`);
        await queryRunner.query(`ALTER TABLE "support_tickets" ALTER COLUMN "status" DROP DEFAULT`);
        ...
        await queryRunner.query(`ALTER TABLE "support_tickets" ALTER COLUMN "category" SET NOT NULL`);
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum_old" AS ENUM('Admin', 'Customer', 'Manager', 'Owner', 'Staff')`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" DROP DEFAULT`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" TYPE "public"."users_role_enum_old" USING "role"::"text"::"public"."users_role_enum_old"`);
        await queryRunner.query(`ALTER TABLE "users" ALTER COLUMN "role" SET DEFAULT 'Customer'`);
        await queryRunner.query(`DROP TYPE "public"."users_role_enum"`);
        await queryRunner.query(`ALTER TYPE "public"."users_role_enum_old" RENAME TO "users_role_enum"`);
        await queryRunner.query(`ALTER TABLE "support_tickets" DROP COLUMN "assignedToId"`);
        await queryRunner.query(`ALTER TABLE "support_tickets" DROP COLUMN "channel"`);
