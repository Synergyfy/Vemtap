...
export class CreatePartnershipsTable1782294062988 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."partnerships_status_enum" AS ENUM('Pending', 'Accepted', 'Declined')`);
        ...
        await queryRunner.query(`ALTER TABLE "partnerships" ADD CONSTRAINT "FK_39b84d18a42bfefc6b1145e2871" FOREIGN KEY ("initiatorBranchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "partnerships" ADD CONSTRAINT "FK_4a5ecee4ced26156b0490e10297" FOREIGN KEY ("recipientBranchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "partnerships" DROP CONSTRAINT "FK_4a5ecee4ced26156b0490e10297"`);
        await queryRunner.query(`ALTER TABLE "partnerships" DROP CONSTRAINT "FK_39b84d18a42bfefc6b1145e2871"`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT 0.01`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostWhatsapp" SET DEFAULT 0.08`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostSms" SET DEFAULT 0.05`);
