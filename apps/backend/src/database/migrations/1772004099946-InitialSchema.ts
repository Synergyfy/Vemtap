...
export class InitialSchema1772004099946 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."products_status_enum" AS ENUM('Published', 'Unpublished')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."quote_negotiations_offeredby_enum" AS ENUM('Admin', 'Owner')`);
        await queryRunner.query(`CREATE TABLE "quote_negotiations" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "createdAt" TIMESTAMP NOT NULL DEFAULT now(), "updatedAt" TIMESTAMP NOT NULL DEFAULT now(), "deletedAt" TIMESTAMP, "quoteId" uuid NOT NULL, "priceOffered" numeric(10,2) NOT NULL, "message" character varying, "offeredBy" "public"."quote_negotiations_offeredby_enum" NOT NULL, "userId" uuid, CONSTRAINT "PK_ea445924cada5fd632e11911309" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."quotes_status_enum" AS ENUM('Pending', 'Admin_Offered', 'Owner_Offered', 'Accepted', 'Rejected', 'Processed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."orders_status_enum" AS ENUM('Pending', 'Ready', 'Completed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."campaigns_status_enum" AS ENUM('Active', 'Scheduled', 'Recurring', 'Draft', 'Completed')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."businesses_type_enum" AS ENUM('RESTAURANT', 'RETAIL', 'GYM', 'EVENT', 'LOGISTICS', 'BEAUTY_WELLNESS')`);
        await queryRunner.query(`CREATE TYPE "public"."businesses_status_enum" AS ENUM('active', 'pending', 'suspended')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."users_role_enum" AS ENUM('Owner', 'Manager', 'Staff', 'Admin', 'Customer')`);
        await queryRunner.query(`CREATE TYPE "public"."users_status_enum" AS ENUM('Active', 'Inactive', 'Invited', 'Pending', 'Suspended')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."support_tickets_status_enum" AS ENUM('Open', 'In Progress', 'Closed')`);
        ...
        await queryRunner.query(`CREATE TABLE "ticket_messages" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "ticketId" uuid NOT NULL, "senderId" uuid NOT NULL, "message" text NOT NULL, "createdAt" TIMESTAMP NOT NULL DEFAULT now(), CONSTRAINT "PK_37beb692dedf7eccb4e519ccec1" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."subscriptions_billingperiod_enum" AS ENUM('monthly', 'quarterly', 'yearly')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."messages_channel_enum" AS ENUM('SMS', 'WHATSAPP', 'EMAIL')`);
        await queryRunner.query(`CREATE TYPE "public"."messages_direction_enum" AS ENUM('INBOUND', 'OUTBOUND')`);
        await queryRunner.query(`CREATE TYPE "public"."messages_status_enum" AS ENUM('PENDING', 'QUEUED', 'SENT', 'DELIVERED', 'FAILED', 'READ', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_logs_status_enum" AS ENUM('PENDING', 'QUEUED', 'SENT', 'DELIVERED', 'FAILED', 'READ', 'REJECTED')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."flow_executions_status_enum" AS ENUM('pending', 'running', 'waiting', 'completed', 'failed', 'cancelled')`);
        ...
        await queryRunner.query(`ALTER TABLE "quote_negotiations" ADD CONSTRAINT "FK_a31b6d23f84fba6864543eaa562" FOREIGN KEY ("quoteId") REFERENCES "quotes"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quote_negotiations" ADD CONSTRAINT "FK_b70842c1a1b49cea8b40efc6393" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quotes" ADD CONSTRAINT "FK_8bad8bd49d1dd6954b46366349c" FOREIGN KEY ("userId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "quotes" ADD CONSTRAINT "FK_0434dd944045bb895f042b8e1c9" FOREIGN KEY ("productId") REFERENCES "products"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "orders" ADD CONSTRAINT "FK_95a206b8b8cafbd842d39aba6cf" FOREIGN KEY ("quoteId") REFERENCES "quotes"("id") ON DELETE RESTRICT ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "campaigns" ADD CONSTRAINT "FK_4b66fabc3b7ca8d3ba55c2c1099" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "branches" ADD CONSTRAINT "FK_b874e5030fa1d52bc338dae8925" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "devices" ADD CONSTRAINT "FK_3120dad6f15b9eb17b57deee7a6" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "devices" ADD CONSTRAINT "FK_d37057046d97dfbff10c95ce14d" FOREIGN KEY ("orderId") REFERENCES "orders"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "devices" ADD CONSTRAINT "FK_0b06457274d1f798765e0f54894" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_78725ac7117e7526e028014606b" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "users" ADD CONSTRAINT "FK_246426dfd001466a1d5e47322f4" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "surveys" ADD CONSTRAINT "FK_c8b08348006a523cf8867b8d0f4" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" ADD CONSTRAINT "FK_7e9f8a764f844a37dc4a968494a" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation_threads" ADD CONSTRAINT "FK_44a6f5f86b7700a3ea88223e1a9" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_cab4c83e89008ff0f36131abe9d" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "message_logs" ADD CONSTRAINT "FK_ed060aa8f4e76711996b1a06c13" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "flow_executions" ADD CONSTRAINT "FK_bca57ea8523d9610d1b6ee80d0d" FOREIGN KEY ("flowId") REFERENCES "flows"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "flow_executions" ADD CONSTRAINT "FK_7d660298759f3645a33f8c2a5f8" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "flow_executions" ADD CONSTRAINT "FK_70981b882106ff89d7f2eb9aab3" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "flows" ADD CONSTRAINT "FK_3da537da5efbca752e2a30914b1" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "flows" ADD CONSTRAINT "FK_9e287b2ba144aaf44c0c2adffcf" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "business_credits" ADD CONSTRAINT "FK_f11168a7a26a635338f6aa21350" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ADD CONSTRAINT "FK_e1e14056207167432227f0eac8f" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "automation_rules" ADD CONSTRAINT "FK_194687193adfc87754348ef4265" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "automation_logs" ADD CONSTRAINT "FK_a1a5b920c1214634ac827607d00" FOREIGN KEY ("ruleId") REFERENCES "automation_rules"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "point_transactions" ADD CONSTRAINT "FK_36d9f26ca7a5abe7d8ac436a4c9" FOREIGN KEY ("loyaltyProfileId") REFERENCES "loyalty_profiles"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "campaign_templates" ADD CONSTRAINT "FK_59cade5e45d1c1f43c938581238" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "campaign_templates" DROP CONSTRAINT "FK_59cade5e45d1c1f43c938581238"`);
        ...
        await queryRunner.query(`ALTER TABLE "point_transactions" DROP CONSTRAINT "FK_36d9f26ca7a5abe7d8ac436a4c9"`);
        ...
        await queryRunner.query(`ALTER TABLE "automation_rules" DROP CONSTRAINT "FK_194687193adfc87754348ef4265"`);
        await queryRunner.query(`ALTER TABLE "automation_rules" DROP CONSTRAINT "FK_e1e14056207167432227f0eac8f"`);
        await queryRunner.query(`ALTER TABLE "business_credits" DROP CONSTRAINT "FK_f11168a7a26a635338f6aa21350"`);
        await queryRunner.query(`ALTER TABLE "flows" DROP CONSTRAINT "FK_9e287b2ba144aaf44c0c2adffcf"`);
        await queryRunner.query(`ALTER TABLE "flows" DROP CONSTRAINT "FK_3da537da5efbca752e2a30914b1"`);
        await queryRunner.query(`ALTER TABLE "flow_executions" DROP CONSTRAINT "FK_70981b882106ff89d7f2eb9aab3"`);
        await queryRunner.query(`ALTER TABLE "flow_executions" DROP CONSTRAINT "FK_7d660298759f3645a33f8c2a5f8"`);
        await queryRunner.query(`ALTER TABLE "flow_executions" DROP CONSTRAINT "FK_9b9d04d4c1921cd1a10afc83d3e"`);
        await queryRunner.query(`ALTER TABLE "flow_executions" DROP CONSTRAINT "FK_bca57ea8523d9610d1b6ee80d0d"`);
        await queryRunner.query(`ALTER TABLE "message_logs" DROP CONSTRAINT "FK_ed060aa8f4e76711996b1a06c13"`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_cab4c83e89008ff0f36131abe9d"`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation_threads" DROP CONSTRAINT "FK_44a6f5f86b7700a3ea88223e1a9"`);
        ...
        await queryRunner.query(`ALTER TABLE "subscriptions" DROP CONSTRAINT "FK_7e9f8a764f844a37dc4a968494a"`);
        ...
        await queryRunner.query(`ALTER TABLE "surveys" DROP CONSTRAINT "FK_c8b08348006a523cf8867b8d0f4"`);
        ...
        await queryRunner.query(`ALTER TABLE "devices" DROP CONSTRAINT "FK_0b06457274d1f798765e0f54894"`);
        await queryRunner.query(`ALTER TABLE "devices" DROP CONSTRAINT "FK_d37057046d97dfbff10c95ce14d"`);
        await queryRunner.query(`ALTER TABLE "devices" DROP CONSTRAINT "FK_3120dad6f15b9eb17b57deee7a6"`);
        await queryRunner.query(`ALTER TABLE "branches" DROP CONSTRAINT "FK_b874e5030fa1d52bc338dae8925"`);
        ...
        await queryRunner.query(`ALTER TABLE "campaigns" DROP CONSTRAINT "FK_4b66fabc3b7ca8d3ba55c2c1099"`);
        ...
        await queryRunner.query(`ALTER TABLE "quotes" DROP CONSTRAINT "FK_0434dd944045bb895f042b8e1c9"`);
        await queryRunner.query(`ALTER TABLE "quotes" DROP CONSTRAINT "FK_8bad8bd49d1dd6954b46366349c"`);
        await queryRunner.query(`ALTER TABLE "quote_negotiations" DROP CONSTRAINT "FK_b70842c1a1b49cea8b40efc6393"`);
        await queryRunner.query(`ALTER TABLE "quote_negotiations" DROP CONSTRAINT "FK_a31b6d23f84fba6864543eaa562"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."quote_negotiations_offeredby_enum"`);
