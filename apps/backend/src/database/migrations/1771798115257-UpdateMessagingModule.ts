...
export class UpdateMessagingModule1771798115257 implements MigrationInterface {
  name = 'UpdateMessagingModule1771798115257';
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" TYPE character varying USING "tierLevel"::text`,
    );
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" SET DEFAULT 'bronze'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" TYPE "public"."loyalty_profiles_tierlevel_enum" USING "tierLevel"::"public"."loyalty_profiles_tierlevel_enum"`,
    );
    await queryRunner.query(
      `ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" SET DEFAULT 'bronze'`,
    );
