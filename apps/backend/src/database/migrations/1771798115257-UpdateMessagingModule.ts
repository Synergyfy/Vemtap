...
export class UpdateMessagingModule1771798115257 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" TYPE "public"."loyalty_profiles_tierlevel_enum" USING "tierLevel"::"public"."loyalty_profiles_tierlevel_enum"`);
        await queryRunner.query(`ALTER TABLE "loyalty_profiles" ALTER COLUMN "tierLevel" SET DEFAULT 'bronze'`);
