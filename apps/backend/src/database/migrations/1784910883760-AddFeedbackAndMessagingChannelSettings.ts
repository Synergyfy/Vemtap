...
export class AddFeedbackAndMessagingChannelSettings1784910883760 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP INDEX "public"."IDX_db473f19f57870839938e70f83"`);
        await queryRunner.query(`DROP INDEX "public"."IDX_69c310fcaa8d87b61bb320ef77"`);
        await queryRunner.query(`DROP TABLE "messaging_channel_settings"`);
        await queryRunner.query(`DROP TYPE "public"."messaging_channel_settings_emaildomainstatus_enum"`);
        await queryRunner.query(`DROP TYPE "public"."messaging_channel_settings_smsrouting_enum"`);
    }
