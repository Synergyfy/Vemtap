...
export class InitMessagingAndSettings1771669529573 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_templates_channel_enum" AS ENUM('SMS', 'WHATSAPP', 'EMAIL')`);
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_logs_channel_enum" AS ENUM('SMS', 'WHATSAPP', 'EMAIL')`);
        await queryRunner.query(`CREATE TYPE "public"."message_logs_direction_enum" AS ENUM('INBOUND', 'OUTBOUND')`);
        await queryRunner.query(`CREATE TYPE "public"."message_logs_status_enum" AS ENUM('PENDING', 'SENT', 'DELIVERED', 'FAILED', 'READ', 'REJECTED')`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation_threads" ADD CONSTRAINT "FK_182cffea6be89d674dae3c6431f" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "conversation_threads" ADD CONSTRAINT "FK_eb40ce34ada4dbd69f44344a1d7" FOREIGN KEY ("contactId") REFERENCES "contacts"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "contacts" ADD CONSTRAINT "FK_d0bcfd4756ee3dc38a0c252b2e2" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        ...
        await queryRunner.query(`ALTER TABLE "message_campaigns" ADD CONSTRAINT "FK_3c04a8d62ced12a0a32c717ab26" FOREIGN KEY ("templateId") REFERENCES "message_templates"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_2234441aac965d27bd93edb33d6" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_435f12bd11014722a707a292763" FOREIGN KEY ("contactId") REFERENCES "contacts"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_15f9bd2bf472ff12b6ee20012d0" FOREIGN KEY ("threadId") REFERENCES "conversation_threads"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "messages" ADD CONSTRAINT "FK_621cca3fc837c781bd415fdf49e" FOREIGN KEY ("campaignId") REFERENCES "message_campaigns"("id") ON DELETE SET NULL ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "message_logs" ADD CONSTRAINT "FK_6cd8838fbb238db1495c608464d" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "message_logs" DROP CONSTRAINT "FK_6cd8838fbb238db1495c608464d"`);
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_621cca3fc837c781bd415fdf49e"`);
        ...
        await queryRunner.query(`ALTER TABLE "messages" DROP CONSTRAINT "FK_2234441aac965d27bd93edb33d6"`);
        await queryRunner.query(`ALTER TABLE "message_campaigns" DROP CONSTRAINT "FK_3c04a8d62ced12a0a32c717ab26"`);
        ...
        await queryRunner.query(`ALTER TABLE "conversation_threads" DROP CONSTRAINT "FK_eb40ce34ada4dbd69f44344a1d7"`);
        await queryRunner.query(`ALTER TABLE "conversation_threads" DROP CONSTRAINT "FK_182cffea6be89d674dae3c6431f"`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT 0.01`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostWhatsapp" SET DEFAULT 0.08`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostSms" SET DEFAULT 0.05`);
        ...
        await queryRunner.query(`DROP TYPE "public"."message_campaigns_status_enum"`);
        await queryRunner.query(`DROP TYPE "public"."message_campaigns_audiencetype_enum"`);
        ...
        await queryRunner.query(`DROP TYPE "public"."conversation_threads_status_enum"`);
