...
export class AgentAdministrationSystem1774344518027 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX "IDX_7e4fdb7733a0384dff5ffca3c9" ON "audit_logs" ("businessId") `,
    );
    await queryRunner.query(
      `CREATE INDEX "IDX_c33f2e04d8b455ce7fe76099f9" ON "audit_logs" ("branchId") `,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "impersonation_tokens" ADD CONSTRAINT "FK_b297bf8294fe7110d14577b0a26" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "impersonation_tokens" ADD CONSTRAINT "FK_a4d8a70ffaf2288be926ed24d5b" FOREIGN KEY ("targetBranchId") REFERENCES "branches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_7e4fdb7733a0384dff5ffca3c95" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_c33f2e04d8b455ce7fe76099f91" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_c33f2e04d8b455ce7fe76099f91"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_7e4fdb7733a0384dff5ffca3c95"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_2dc33f7f3c22e2e7badafca1d12"`,
    );
    await queryRunner.query(
      `ALTER TABLE "impersonation_tokens" DROP CONSTRAINT "FK_a4d8a70ffaf2288be926ed24d5b"`,
    );
    await queryRunner.query(
      `ALTER TABLE "impersonation_tokens" DROP CONSTRAINT "FK_b297bf8294fe7110d14577b0a26"`,
    );
    await queryRunner.query(
      `ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT 0.01`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_c33f2e04d8b455ce7fe76099f9"`,
    );
    await queryRunner.query(
      `DROP INDEX "public"."IDX_7e4fdb7733a0384dff5ffca3c9"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_aa55c42e3fea4fcdb4d07e9143"`,
    );
