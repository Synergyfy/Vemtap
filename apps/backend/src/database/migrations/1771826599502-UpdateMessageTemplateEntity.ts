...
export class UpdateMessageTemplateEntity1771826599502 implements MigrationInterface {
    name = 'UpdateMessageTemplateEntity1771826599502'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TYPE "public"."message_templates_status_enum" AS ENUM('pending', 'approved', 'rejected')`);
        await queryRunner.query(`ALTER TABLE "message_templates" ADD "status" "public"."message_templates_status_enum" NOT NULL DEFAULT 'pending'`);
        await queryRunner.query(`CREATE TYPE "public"."message_templates_category_enum" AS ENUM('MARKETING', 'UTILITY', 'AUTHENTICATION')`);
        await queryRunner.query(`ALTER TABLE "message_templates" ADD "category" "public"."message_templates_category_enum" NOT NULL DEFAULT 'MARKETING'`);
        await queryRunner.query(`ALTER TABLE "message_templates" ADD "language" character varying NOT NULL DEFAULT 'English (US)'`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "loyalty_profiles" DROP COLUMN "businessId"`);
        await queryRunner.query(`ALTER TABLE "rewards" DROP COLUMN "businessId"`);
        await queryRunner.query(`ALTER TABLE "message_templates" DROP COLUMN "language"`);
        await queryRunner.query(`ALTER TABLE "message_templates" DROP COLUMN "category"`);
        await queryRunner.query(`DROP TYPE "public"."message_templates_category_enum"`);
        await queryRunner.query(`ALTER TABLE "message_templates" DROP COLUMN "status"`);
        await queryRunner.query(`DROP TYPE "public"."message_templates_status_enum"`);
        await queryRunner.query(`ALTER TABLE "redemptions" ADD "branchId" character varying`);
        await queryRunner.query(`ALTER TABLE "loyalty_profiles" ADD "businessId" uuid NOT NULL`);
        await queryRunner.query(`ALTER TABLE "rewards" ADD "businessId" uuid NOT NULL`);
        await queryRunner.query(`CREATE INDEX "IDX_80d0596c9acaf40cf1ba7175ae" ON "loyalty_profiles" ("branchId") `);
