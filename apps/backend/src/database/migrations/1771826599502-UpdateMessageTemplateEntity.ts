...
export class UpdateMessageTemplateEntity1771826599502 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD "status" "public"."message_templates_status_enum" NOT NULL DEFAULT 'pending'`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."message_templates_category_enum" AS ENUM('MARKETING', 'UTILITY', 'AUTHENTICATION')`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD "category" "public"."message_templates_category_enum" NOT NULL DEFAULT 'MARKETING'`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD "language" character varying NOT NULL DEFAULT 'English (US)'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."loyalty_profiles_tierlevel_enum" AS ENUM('bronze', 'silver', 'gold', 'platinum')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(`ALTER TABLE "rewards" DROP COLUMN "businessId"`);
    await queryRunner.query(
      `ALTER TABLE "message_templates" DROP COLUMN "language"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "message_templates" DROP COLUMN "status"`,
    );
    await queryRunner.query(
