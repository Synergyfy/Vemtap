...
export class AddAudienceTypeToReward1774430392727 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."rewards_audiencetype_enum" AS ENUM('new', 'returning', 'all')`,
    );
    await queryRunner.query(
      `ALTER TABLE "rewards" ADD "audienceType" "public"."rewards_audiencetype_enum" NOT NULL DEFAULT 'all'`,
    );
    await queryRunner.query(
