...
export class AddSenderTypeToMessages1775937155362 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TYPE "public"."ticket_messages_sendertype_enum" AS ENUM('USER', 'AGENT', 'BOT')`,
    );
    await queryRunner.query(
      `ALTER TABLE "ticket_messages" ADD "senderType" "public"."ticket_messages_sendertype_enum" NOT NULL DEFAULT 'USER'`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "ticket_messages" DROP COLUMN "senderType"`,
    );
    await queryRunner.query(
      `DROP TYPE "public"."ticket_messages_sendertype_enum"`,
    );
  }
}
