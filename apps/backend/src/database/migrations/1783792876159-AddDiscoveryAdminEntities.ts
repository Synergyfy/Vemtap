...
export class AddDiscoveryAdminEntities1783792876159 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE TYPE "public"."fraud_alerts_severity_enum" AS ENUM('High', 'Medium', 'Low')`,
    );
    await queryRunner.query(
      `CREATE TYPE "public"."fraud_alerts_status_enum" AS ENUM('Flagged', 'Investigating', 'Resolved')`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaigns" ADD CONSTRAINT "FK_9b6b1c26bffbf3698c89ef34d2d" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaigns" ADD CONSTRAINT "FK_4455e8754faa386f59c4e3db298" FOREIGN KEY ("branchId") REFERENCES "branches"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaign_transactions" ADD CONSTRAINT "FK_f6fc57aacfa8da8d2a2c1882085" FOREIGN KEY ("campaignId") REFERENCES "sponsored_campaigns"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "discovery_reports" ADD CONSTRAINT "FK_38d6dde29a42e469f483f785b26" FOREIGN KEY ("generatedById") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "discovery_invoices" ADD CONSTRAINT "FK_7e6f7ab7a2f9ce0eb0bd6fd6f48" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_line_items" ADD CONSTRAINT "FK_2ec8b1cda36ed79a7ded49bd913" FOREIGN KEY ("invoiceId") REFERENCES "discovery_invoices"("id") ON DELETE CASCADE ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "fraud_alerts" ADD CONSTRAINT "FK_73689f2b8163acf8be991de94f5" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "fraud_alerts" ADD CONSTRAINT "FK_0464a0aa1b46bbedf27a25bfce3" FOREIGN KEY ("customerId") REFERENCES "users"("id") ON DELETE SET NULL ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "fraud_alerts" DROP CONSTRAINT "FK_0464a0aa1b46bbedf27a25bfce3"`,
    );
    await queryRunner.query(
      `ALTER TABLE "fraud_alerts" DROP CONSTRAINT "FK_73689f2b8163acf8be991de94f5"`,
    );
    await queryRunner.query(
      `ALTER TABLE "invoice_line_items" DROP CONSTRAINT "FK_2ec8b1cda36ed79a7ded49bd913"`,
    );
    await queryRunner.query(
      `ALTER TABLE "discovery_invoices" DROP CONSTRAINT "FK_7e6f7ab7a2f9ce0eb0bd6fd6f48"`,
    );
    await queryRunner.query(
      `ALTER TABLE "discovery_reports" DROP CONSTRAINT "FK_38d6dde29a42e469f483f785b26"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaign_transactions" DROP CONSTRAINT "FK_f6fc57aacfa8da8d2a2c1882085"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaigns" DROP CONSTRAINT "FK_4455e8754faa386f59c4e3db298"`,
    );
    await queryRunner.query(
      `ALTER TABLE "sponsored_campaigns" DROP CONSTRAINT "FK_9b6b1c26bffbf3698c89ef34d2d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT 0.01`,
    );
    ...
    await queryRunner.query(
      `DROP TYPE "public"."discovery_invoices_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "notification_logs"`);
    await queryRunner.query(
      `DROP TYPE "public"."notification_logs_openstatus_enum"`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `DROP TYPE "public"."offer_category_types_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "discovery_reports"`);
    await queryRunner.query(
      `DROP TYPE "public"."discovery_reports_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "sponsored_campaign_transactions"`);
    await queryRunner.query(
      `DROP TYPE "public"."sponsored_campaign_transactions_status_enum"`,
    );
    await queryRunner.query(`DROP TABLE "sponsored_campaigns"`);
    await queryRunner.query(
      `DROP TYPE "public"."sponsored_campaigns_status_enum"`,
    );
  }
}
