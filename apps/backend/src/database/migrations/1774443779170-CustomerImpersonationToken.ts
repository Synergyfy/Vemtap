...
export class CustomerImpersonationToken1774443779170 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "customer_impersonation_tokens" ADD CONSTRAINT "FK_656b8f75d895893c73c4b258f2d" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer_impersonation_tokens" ADD CONSTRAINT "FK_38cbaa26a84189a093243f770c7" FOREIGN KEY ("targetCustomerId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }

  public async down(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "customer_impersonation_tokens" DROP CONSTRAINT "FK_38cbaa26a84189a093243f770c7"`,
    );
    await queryRunner.query(
      `ALTER TABLE "customer_impersonation_tokens" DROP CONSTRAINT "FK_656b8f75d895893c73c4b258f2d"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" DROP CONSTRAINT "FK_2dc33f7f3c22e2e7badafca1d12"`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" ALTER COLUMN "actorId" SET NOT NULL`,
    );
    await queryRunner.query(
      `ALTER TABLE "audit_logs" ADD CONSTRAINT "FK_2dc33f7f3c22e2e7badafca1d12" FOREIGN KEY ("actorId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
    ...
    await queryRunner.query(
      `DROP INDEX "public"."IDX_dac193573ee76b8a0d4c1fce53"`,
    );
