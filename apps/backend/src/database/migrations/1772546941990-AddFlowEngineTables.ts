...
export class AddFlowEngineTables1772546941990 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "settings" ADD "whatsappApiToken" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "whatsappWebhookVerifyToken" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "whatsappBusinessId" character varying`);
        await queryRunner.query(`ALTER TABLE "settings" ADD "whatsappApiBaseUrl" character varying NOT NULL DEFAULT 'https://graph.facebook.com/v17.0/'`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostSms" SET DEFAULT '0.05'`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostWhatsapp" SET DEFAULT '0.08'`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT '0.01'`);
        await queryRunner.query(`ALTER TABLE "flow_logs" ADD CONSTRAINT "FK_6266e50486828fe7acee0227b64" FOREIGN KEY ("flowSessionId") REFERENCES "flow_executions"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
        await queryRunner.query(`ALTER TABLE "flow_logs" ADD CONSTRAINT "FK_cd00964004b0c83a1fe754abd96" FOREIGN KEY ("businessId") REFERENCES "businesses"("id") ON DELETE CASCADE ON UPDATE NO ACTION`);
    }

    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`ALTER TABLE "flow_logs" DROP CONSTRAINT "FK_cd00964004b0c83a1fe754abd96"`);
        await queryRunner.query(`ALTER TABLE "flow_logs" DROP CONSTRAINT "FK_6266e50486828fe7acee0227b64"`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostEmail" SET DEFAULT 0.01`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostWhatsapp" SET DEFAULT 0.08`);
        await queryRunner.query(`ALTER TABLE "settings" ALTER COLUMN "messagingCostSms" SET DEFAULT 0.05`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "whatsappApiBaseUrl"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "whatsappBusinessId"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "whatsappWebhookVerifyToken"`);
        await queryRunner.query(`ALTER TABLE "settings" DROP COLUMN "whatsappApiToken"`);
