...
export class UpdateMessageTemplatesAndSettings1772448441793 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD "isSystem" boolean NOT NULL DEFAULT false`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD "createdById" uuid`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "message_templates" ALTER COLUMN "businessId" DROP NOT NULL`,
    );
    await queryRunner.query(
    ...
    await queryRunner.query(
      `ALTER TABLE "message_templates" ADD CONSTRAINT "UQ_46169ec413a139c2b9866e28aa4" UNIQUE ("businessId", "name", "channel")`,
    );
    await queryRunner.query(
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "message_templates" DROP COLUMN "createdById"`,
    );
    await queryRunner.query(
      `ALTER TABLE "message_templates" DROP COLUMN "isSystem"`,
    );
  }
}
