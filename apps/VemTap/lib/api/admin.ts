...
export const adminProductsApi = {
    ...
    getCountByType: (productTypeId: string) => api.get(`/products/admin/count-by-type/${productTypeId}`),
};
...
export const adminSubscriptionsApi = {
    ...
    subscribe: (data: { planId: string; businessId: string; billingPeriod: 'monthly' | 'quarterly' | 'yearly'; paymentReference?: string; isTrial?: boolean; isAdminOverride?: boolean; customEndDate?: string }) =>
...
export const adminBannersApi = {
    list: (placement?: 'business' | 'customer' | 'homepage' | 'deals-page') =>
