    ...
    return (
        <div className="pb-32 md:pb-20 max-w-5xl mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div>
                    <div className="flex items-center gap-2"><h1 className="text-3xl font-black text-gray-900 leading-tight">Referral Tracking</h1><PageGuideButton /><AICopilotButton /></div>
            ...
            <div className="space-y-4">
                {referrals.map((ref) => (
                    <div key={ref.id} className="group p-6 rounded-[32px] bg-white border border-gray-100 shadow-sm hover:border-[#066CF4]/20 hover:shadow-xl transition-all">
                        <div className="flex flex-col md:flex-row md:items-center justify-between gap-6">
                            <div className="flex items-center gap-4">
                                <div className="size-16 rounded-2xl bg-blue-50 text-[#066CF4] flex items-center justify-center font-black text-sm">
                                    {ref.business[0]}
                                </div>
                                <div>
                                    <h4 className="text-base font-black text-gray-900">{ref.business}</h4>
                                    <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">{ref.owner} • {ref.date}</p>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-8 px-4">
                                ...
                                <div>
                                    <p className="text-sm font-black text-gray-900">{ref.comm}</p>
                                    <p className="text-[8px] font-black text-gray-400 uppercase tracking-widest">Comm.</p>
                                </div>
                            </div>
                        </div>
                    </div>
