    ...
    return (
        <div className="pb-32 md:pb-20 max-w-7xl mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div>
                    <div className="flex items-center gap-2"><h1 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight leading-tight">Reactivation Automation</h1><PageGuideButton /><AICopilotButton /></div>
            ...
            {/* FLOW VISUALIZATION */}
            <div className="rounded-2xl bg-gray-50 border border-gray-100 p-8 mb-8 flex flex-col items-center justify-center text-center relative overflow-hidden">
                ...
                <div className="flex flex-col md:flex-row items-center gap-6 relative z-10">
                    <div className="flex flex-col items-center gap-3">
                        <div className="size-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-rose-500">
                            <Clock size={22} />
                        </div>
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-900">Inactive Detected</span>
                    </div>
                    <ArrowLeft className="hidden md:block text-gray-200 rotate-180" size={24} />
                    <div className="flex flex-col items-center gap-3">
                        <div className="size-12 rounded-xl bg-rose-500 shadow-md shadow-rose-500/20 flex items-center justify-center text-white">
                            <Gift size={22} />
                        </div>
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-900">Win-back Offer</span>
                    </div>
                    <ArrowLeft className="hidden md:block text-gray-200 rotate-180" size={24} />
                    <div className="flex flex-col items-center gap-3">
                        <div className="size-12 rounded-xl bg-white shadow-sm flex items-center justify-center text-emerald-500">
                            <Target size={22} />
                        </div>
                        <span className="text-[10px] font-semibold uppercase tracking-wider text-gray-900">Customer Returns</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-7 space-y-8">
                    ...
                    <div className="rounded-2xl bg-white p-5 md:p-6 shadow-sm border border-gray-100">
                        <h4 className="text-base md:text-lg font-bold text-gray-900 mb-4">Define Inactive Customer</h4>
                        <p className="text-xs font-medium text-gray-400 tracking-wide mb-6 leading-relaxed">Trigger message if customer hasn&apos;t visited for:</p>
                    ...
                    {/* COMPOSER */}
                    <div className="rounded-2xl bg-white p-5 md:p-6 shadow-sm border border-gray-100">
                        <h3 className="text-base md:text-lg font-bold text-gray-900 mb-6">Reactivation Message</h3>
                        <AutomationComposer 
                            channel={channel} 
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    {/* ESTIMATE CARD */}
                    <div className="rounded-2xl bg-rose-50/50 border border-rose-100 p-5 md:p-6">
                        <h4 className="text-xs font-semibold uppercase tracking-wider text-rose-900 mb-6">Automation Estimate</h4>
                        <div className="space-y-4">
                            <div className="flex justify-between items-center">
                                <span className="text-[10px] font-semibold uppercase tracking-wider text-rose-800/60">Eligible Customers</span>
                                <span className="text-lg font-bold text-rose-900">890</span>
                            </div>
                            <div className="flex justify-between items-center">
                                <span className="text-[10px] font-semibold uppercase tracking-wider text-rose-800/60">Potential Recoveries</span>
                                <span className="text-lg font-bold text-rose-900">~145</span>
                            </div>
                        </div>
                    </div>
