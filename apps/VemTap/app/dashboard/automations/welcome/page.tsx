            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                ...
                <div className="lg:col-span-7 space-y-8">
                    ...
                    <div className="rounded-[40px] bg-white p-8 shadow-sm border border-gray-100">
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Compose Welcome Message</h3>
                        <AutomationComposer 
                            channel={channel} 
                    ...
                    <div className="rounded-[32px] bg-emerald-50/50 border border-emerald-100 p-8 flex items-center justify-between">
                        <div className="flex items-center gap-4">
                            <div className="size-12 rounded-2xl bg-white flex items-center justify-center text-emerald-600 shadow-sm">
                                <Badge className="bg-emerald-100 text-emerald-600 border-none font-black text-[10px]">%</Badge>
                            </div>
                            <div>
                                <h4 className="text-sm font-black text-gray-900 uppercase tracking-widest">Welcome Discount</h4>
                                <p className="text-[10px] font-medium text-gray-500 uppercase tracking-widest mt-0.5">Include a coupon in the first message.</p>
                            </div>
                        </div>
                        <button className="h-10 px-6 rounded-xl bg-emerald-600 text-white text-[9px] font-black uppercase tracking-widest active:scale-95 transition-all">Enabled</button>
                    </div>
                </div>
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    <Button variant="ghost" className="w-full h-12 text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-[#066CF4]">
