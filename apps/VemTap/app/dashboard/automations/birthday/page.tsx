    ...
    return (
        <div className="pb-32 md:pb-20 max-w-5xl mx-auto p-4 md:p-8">
            ...
            <div className="flex flex-col md:flex-row md:items-center justify-between gap-6 mb-12">
                <div>
                    <h1 className="text-3xl font-black text-gray-900 leading-tight">Birthday Automation</h1>
            ...
            {/* FLOW VISUALIZATION */}
            <div className="rounded-[40px] bg-gray-50 border border-gray-100 p-12 mb-8 flex flex-col items-center justify-center text-center">
                <div className="flex flex-col md:flex-row items-center gap-6">
                    <div className="flex flex-col items-center gap-3">
                        <div className="size-16 rounded-2xl bg-white shadow-sm flex items-center justify-center text-purple-600">
                            <Cake size={28} />
                        </div>
                        <span className="text-[10px] font-black uppercase tracking-widest text-gray-900">Birthday Detected</span>
                    </div>
                    <ArrowLeft className="hidden md:block text-gray-200 rotate-180" size={24} />
                    <div className="flex flex-col items-center gap-3">
                        <div className="size-16 rounded-2xl bg-purple-600 shadow-xl shadow-purple-500/20 flex items-center justify-center text-white">
                            <Gift size={28} />
                        </div>
                        <span className="text-[10px] font-black uppercase tracking-widest text-gray-900">Special Reward</span>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-12 gap-8">
                <div className="lg:col-span-7 space-y-8">
                    ...
                    <div className="rounded-[32px] bg-white p-8 shadow-sm border border-gray-100">
                        <h4 className="text-xs font-black uppercase tracking-widest text-gray-400 mb-6">Send Timing</h4>
                    ...
                    <div className="rounded-[40px] bg-white p-8 shadow-sm border border-gray-100">
                        <h3 className="text-sm font-black text-gray-900 uppercase tracking-widest mb-8">Birthday Message</h3>
                        <AutomationComposer 
                            channel={channel} 
                ...
                <div className="lg:col-span-5 space-y-8">
                    ...
                    <div className="rounded-[32px] bg-purple-50/50 border border-purple-100 p-8">
                        <div className="flex items-center gap-4 mb-6">
                            <div className="size-10 rounded-xl bg-white shadow-sm flex items-center justify-center text-purple-600">
                                <Sparkles size={20} />
                            </div>
                            <h4 className="text-sm font-black text-purple-900 uppercase tracking-widest">Example Schedule</h4>
                        </div>
                        <div className="p-4 rounded-2xl bg-white border border-purple-100">
                           <div className="flex items-center gap-3">
                              ...
                              <div>
                                 <p className="text-xs font-black text-gray-900">John's birthday is tomorrow</p>
                                 <p className="text-[10px] font-bold text-gray-400 uppercase tracking-widest">Message scheduled</p>
                              </div>
                           </div>
                        </div>
                    </div>
