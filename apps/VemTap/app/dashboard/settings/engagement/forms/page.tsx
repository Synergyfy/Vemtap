        ...
        <div className="p-8 space-y-8">
            ...
            <div className="grid grid-cols-2 xl:grid-cols-[1.05fr,0.95fr] gap-6">
                <div className="bg-white rounded-2xl border border-gray-200 p-6 space-y-4">
                    ...
                    {step === 3 && <div className="grid grid-cols-2 gap-3"><div className="rounded-xl border border-gray-200 p-3 flex items-center gap-3"><div className="size-12 rounded-xl border border-gray-200 overflow-hidden bg-white flex items-center justify-center">{currentBusinessLogo ? <img src={currentBusinessLogo} alt={currentBusinessName || 'Business'} className="w-full h-full object-cover" /> : <span className="text-sm font-black text-slate-900">{(currentBusinessName || 'B').charAt(0)}</span>}</div><div><p className="text-[10px] font-black uppercase tracking-widest text-text-secondary">Current Business</p><p className="text-sm font-bold text-text-main">{currentBusinessName}</p></div></div><div className="rounded-xl border border-gray-200 p-3"><p className="text-[10px] font-black uppercase tracking-widest text-text-secondary">Branch</p><p className="text-sm font-bold text-text-main">{branchName}</p></div></div>}
