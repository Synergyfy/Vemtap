...
export default function OrdersDashboard() {
  ...
  const addItemsToCartAndCheckout = (items: any[]) => {
    ...
    router.push('/dashboard/pos/payment');
  };
  ...
  const handleAcceptOrder = () => {
    ...
    addItemsToCartAndCheckout(orderDetail.items);
    updateStatus.mutate(
      { id: selectedOrderId!, status: 'processing' as OrderStatus },
      { onSuccess: () => toast.success('Order added to cart!') }
    );
  };
                  ...
                  <>
                    ...
                    <div className="pt-2 space-y-2">
                      ...
                      {orderDetail.status === 'processing' && (
                        ...
                        >
                          {updateStatus.isPending ? <Loader2 size={16} className="animate-spin" /> : <CheckCircle size={18} />}
                          Mark Complete
                        </button>
                      )}
