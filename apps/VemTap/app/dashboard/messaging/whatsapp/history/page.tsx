...
export default function WhatsAppHistoryPage() {
    ...
    const broadcasts = (campaigns || []).filter(
        (item) => item.channel?.toUpperCase() === 'WHATSAPP'
    );
    ...
    return (
        <div className="p-4 md:p-8 pb-24 md:pb-8 space-y-6">
            ...
            <div>
                <h1 className="text-xl md:text-2xl font-bold text-gray-900 tracking-tight">WhatsApp History</h1>
                <p className="text-sm text-text-secondary font-medium">View all your past WhatsApp messages and broadcasts.</p>
            </div>
                ...
                <DataTable
                    ...
                    emptyState={
                        <div className="text-center py-20">
                            ...
                            <h3 className="text-lg font-bold text-text-main">No WhatsApp history found</h3>
                            <p className="text-text-secondary text-sm">No WhatsApp messages match your current search.</p>
                        </div>
                    }
                />
