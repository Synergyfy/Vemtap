    ...
    if (!form) {
        return (
            <div className="p-6 sm:p-8">
                ...
                <Link href="/dashboard/engagement/forms" className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:underline">
                    ← Back to Forms
                </Link>
            </div>
        );
    ...
    return (
        <div className="p-4 sm:p-6 lg:p-8 space-y-6">
            ...
            <div className="flex flex-wrap items-center gap-3">
                <Link href="/dashboard/engagement/socials" className="px-4 h-9 rounded-lg bg-white border border-gray-200 text-sm font-medium text-gray-600 flex items-center hover:bg-gray-50 transition-colors">Socials</Link>
                <Link href="/dashboard/engagement/forms" className="px-4 h-9 rounded-lg bg-primary text-white text-sm font-semibold flex items-center shadow-sm">Form Creator</Link>
                <Link href="/dashboard/engagement/forms/responses" className="px-4 h-9 rounded-lg bg-white border border-gray-200 text-sm font-medium text-gray-600 flex items-center hover:bg-gray-50 transition-colors">Responses</Link>
            </div>
                    ...
                    <PhoneFrame title="Live Phone Preview">
                        <div className="min-h-full bg-gradient-to-br from-slate-50 via-gray-50 to-slate-100 py-6 px-3 space-y-3">
                            ...
                            <p className="text-center text-[8px] font-medium text-slate-400">
                                Powered by <span className="font-bold" style={{ color: brandColor }}>{myBusiness?.name || user?.businessName || form.businessName || 'VemTap'}</span>
                            </p>
                        </div>
                    </PhoneFrame>
                </div>
