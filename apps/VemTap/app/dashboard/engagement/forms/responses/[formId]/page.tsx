    ...
    if (!form) {
        return (
            <div className="p-8 space-y-4">
                <Link href="/dashboard/engagement/forms/responses" className="inline-flex items-center gap-2 text-sm font-bold text-primary">
    ...
    return (
        <div className="p-8 space-y-8">
            ...
            <div className="flex items-center gap-3 flex-wrap">
                <Link href="/dashboard/engagement/forms/responses" className="px-4 h-10 rounded-xl bg-white border border-gray-200 text-sm font-bold text-text-secondary flex items-center gap-2">
                    <ArrowLeft size={14} />
                    Back
                </Link>
