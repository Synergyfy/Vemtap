                ...
                <div className="max-w-md w-full mx-auto">
                    ...
                    <div className="mt-10">
                        ...
                        <button
                            ...
                            className="w-full h-16 rounded-2xl border-2 border-gray-100 font-bold text-sm flex items-center justify-center gap-3 hover:bg-gray-50 transition-all cursor-pointer disabled:opacity-60 disabled:cursor-not-allowed"
                        >
                            {isGooglePrompting ? (
