    ...
    return (
        <div className="min-h-screen bg-white">
            ...
            <div className="pt-24 md:pt-32 pb-16 bg-slate-50 relative overflow-hidden">
                ...
                <div className="relative z-10 vemtap-container text-center">
                    ...
                    <p className="text-base md:text-lg lg:text-xl text-text-secondary vemtap-container font-normal leading-relaxed">
            ...
            <section className="py-16 md:py-20 bg-slate-50 text-text-main overflow-hidden relative">
                ...
                <div className="vemtap-container relative z-10 text-center">
