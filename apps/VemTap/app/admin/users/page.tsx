...
import { Search, UserPlus, Edit2, Lock, Ban, Loader2, RefreshCw, Download } from 'lucide-react';
    ...
    return (
        <div className="p-4 md:p-8 space-y-8">
            ...
            <div className="flex items-center justify-between">
                <div>
                    <h1 className="text-3xl font-display font-bold text-text-main mb-1">User Management</h1>
                    <p className="text-text-secondary font-medium text-sm">Manage and monitor all platform users</p>
                </div>
                ...
                {stats.map((stat, i) => (
                    <div key={i} className="bg-white rounded-xl p-5 border border-gray-200 shadow-sm">
                        <div className="flex items-center gap-3">
                            <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${stat.color === 'green' ? 'bg-green-50 text-green-600' : stat.color === 'purple' ? 'bg-purple-50 text-purple-600' : stat.color === 'orange' ? 'bg-orange-50 text-orange-600' : 'bg-blue-50 text-blue-600'}`}>
                        ...
                        <form onSubmit={handleFormSubmit} className="space-y-5">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <select name="role" defaultValue={selectedUser?.role || 'Customer'} className="w-full h-12 px-4 bg-gray-50 border border-gray-200 rounded-xl text-sm font-bold focus:outline-none focus:ring-4 focus:ring-primary/10 focus:bg-white transition-all">
                                        <option value="Admin">Admin</option>
                                        <option value="Owner">Owner</option>
                                        <option value="Manager">Manager</option>
                                        <option value="Staff">Staff</option>
