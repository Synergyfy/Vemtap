...
import type { AdminSponsoredCampaign } from '@/services/discovery/types';
import { 
                        ...
                        <tbody className="divide-y divide-gray-50 text-sm">
                            {isLoading ? (
                                Array.from({ length: 3 }).map((_, i) => (
                                    <tr key={`skeleton-${i}`}>
                                        <td className="px-6 py-4"><div className="h-4 w-40 bg-gray-100 rounded animate-pulse" /></td>
                                        ...
                                        <td className="px-6 py-4"><div className="h-4 w-20 bg-gray-100 rounded animate-pulse ml-auto" /></td>
                                    </tr>
                                ))
                            ) : (
                                campaigns.map((camp) => (
