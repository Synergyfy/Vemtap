export const presets = {
    ...
    card: "w-full max-w-[420px] bg-white rounded-[2.5rem] p-6 md:p-10 shadow-[0_30px_60px_-15px_rgba(0,0,0,0.1)] border border-slate-100 relative",
    ...
    label: "text-slate-700 text-[7.5px] font-black uppercase tracking-widest mb-0.5 ml-1 block",
