...
export const StepForm: React.FC<StepFormProps> = ({
    ...
    if (view === 'success-phone') {
        ...
        <motion.div 
            ...
            initial={{ opacity: 0, y: 10 }} 
            animate={{ opacity: 1, y: 0 }} 
            className={cn(presets.card, "flex flex-col p-0 overflow-hidden max-h-[90vh]")}
        >
            <div className="shrink-0 p-6 md:p-8 border-b border-slate-50 bg-white relative">
                ...
                <div className="flex flex-col items-center text-center pt-4">
                    ...
                    <h1 className="text-xl md:text-2xl font-black text-slate-900 tracking-tight leading-tight mb-1 text-center">
                        Signed up successfully!
                    </h1>
                    <p className="text-xs font-medium text-slate-500 leading-relaxed max-w-sm text-center mx-auto">
                        Welcome, {googleUser?.firstName || 'there'}! Add your phone number to stay in touch.
                    </p>
                </div>
            </div>
            ...
            <div className="shrink-0 p-6 md:p-8 border-t border-slate-50 bg-white">
                ...
                <div className="mt-4 pt-4 border-t border-slate-50 text-[9px] text-gray-400 font-bold uppercase tracking-widest text-center">
