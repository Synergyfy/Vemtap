...
const GoogleLoginWrapper = ({ onSuccess, label, isLoading }: any) => {
    return (
        <div className="w-full relative group">
            ...
            <div className="w-full h-11 flex items-center justify-center gap-3 bg-white hover:bg-slate-50 transition-all duration-300 rounded-xl shadow-[0_1px_3px_0_rgba(0,0,0,0.1),0_1px_2px_0_rgba(0,0,0,0.06)] active:scale-[0.98] cursor-pointer overflow-hidden">
