...
export default function RewardStatCard({ 
    ...
    return (
        <motion.div 
            ...
            className="bg-white/80 backdrop-blur-sm rounded-2xl md:rounded-3xl p-4 md:p-6 border border-gray-100 shadow-sm hover:shadow-md transition-all duration-300 group"
        >
            <div className="flex items-start justify-between">
                <div className={`p-2 md:p-3 rounded-xl md:rounded-2xl bg-${color}/10 text-${color} group-hover:scale-110 transition-transform duration-300`}>
            ...
            <div className="mt-3 md:mt-4">
                ...
                <div className="flex items-baseline gap-2 mt-1">
                    <span className="text-xl md:text-3xl font-bold text-gray-900">{value}</span>
                </div>
                {description && (
