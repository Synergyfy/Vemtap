...
export default function LocationPrompt(props: LocationPromptProps & LegacyLocationProps) {
  const { isOpen, onClose, onAllowLocation, onSearchLocation, isLoading, error, location, onLocationSet, variant, label, className, closable = true } = props;
  ...
  return (
    <div
      ...
      onClick={closable ? _onClose : undefined}
    >
      <div
