                    ...
                    <div className="grid grid-cols-2 gap-4">
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => updateData({ vcard: { ...(data.vcard || {} as any), mobile: e.target.value.replace(/\D/g, '') } })}
                      ...
                      <div className="space-y-2">
                        ...
                        <input
                          ...
                          onChange={(e) => updateData({ vcard: { ...(data.vcard || {} as any), phone: e.target.value.replace(/\D/g, '') } })}
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative group">
                    ...
                    <input
                      ...
                      onChange={(e) => updateData({ sms: { ...(data.sms || { message: '' }), number: e.target.value.replace(/\D/g, '') } })}
                      placeholder="+1 234 567 890"
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative group">
                      ...
                      <input
                        ...
                        onChange={(e) => updateData({ whatsapp: { ...(data.whatsapp || { message: '' }), phoneNumber: e.target.value.replace(/\D/g, '') } })}
                    ...
                    <div className="space-y-4">
                      <div className="grid grid-cols-2 gap-4">
                        ...
                        <div className="space-y-2">
                          ...
                          <input type="tel" className="w-full px-4 py-3 border-2 border-gray-50 rounded-xl outline-none font-bold text-gray-900 bg-gray-50/30 text-sm" placeholder="+1 234 567 890" value={data.business?.contact?.phone || ''} onChange={(e) => updateData({ business: { ...(data.business || {}), contact: { ...(data.business?.contact || {}), phone: e.target.value.replace(/\D/g, '') } } })} />
                        </div>
                      </div>
                      <div className="space-y-2">
                      ...
                      {data.menu?.showWhatsappCta && (
                        <div className="space-y-2 animate-in fade-in slide-in-from-top-2 duration-300">
                          ...
                          <div className="relative">
                            ...
                            <input type="tel" className="w-full pl-10 pr-4 py-3 border-2 border-gray-50 rounded-xl outline-none font-bold text-gray-900 bg-gray-50/30 text-sm" placeholder="+234 801 234 5678" value={data.menu?.whatsappNumber || ''} onChange={(e) => updateData({ menu: { ...(data.menu || {}), whatsappNumber: e.target.value.replace(/\D/g, '') } })} />
                          </div>
