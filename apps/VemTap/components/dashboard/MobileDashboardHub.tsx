...
export default function MobileDashboardHub() {
    ...
    const sections = [
        { label: 'Dashboard', icon: Home, href: '/dashboard?show_stats=1', color: 'bg-emerald-50 text-emerald-600', roles: ['owner', 'manager', 'staff'], permission: 'dashboard' },
        { label: 'Visitors', icon: Users, href: '/dashboard/visitors', color: 'bg-teal-50 text-teal-600', roles: ['owner', 'manager', 'staff'], permission: 'visitors' },
        { label: 'In-App Chat', icon: MessageCircle, href: '/dashboard/messaging/chat', color: 'bg-blue-50 text-blue-600', roles: ['owner', 'manager', 'staff'], permission: 'chat' },
        { label: 'Channels', icon: MessageSquare, href: '/dashboard/messaging', color: 'bg-indigo-50 text-indigo-600', roles: ['owner', 'manager'], permission: 'messages' },
        { label: 'Loyalty', icon: Gift, href: '/dashboard/loyalty', color: 'bg-amber-50 text-amber-600', roles: ['owner', 'manager', 'staff'], permission: 'loyalty' },
        { label: 'Catalogue', icon: ShoppingBag, href: '/dashboard/catalogue', color: 'bg-rose-50 text-rose-600', roles: ['owner', 'manager'], permission: 'catalogue' },
        { label: 'Advanced Analytics', icon: BarChart, href: '/dashboard/analytics', color: 'bg-cyan-50 text-cyan-600', roles: ['owner', 'manager'], permission: 'analytics' },
    ...
    const filteredSections = sections.filter(section => canAccessMenuItem(section, userRole, userPermissions, isOwnerOrAdmin));
